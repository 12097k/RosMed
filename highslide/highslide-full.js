...
lang : {
	...
	fullExpandTitle : 'Развернуть на фактический размер (f)',
	creditsText : 'Работает на <i>Highslide JS</i>',
	creditsTitle : 'Посетите сайт Highslide JS',
